return {
    ...
    config = function()
        ...
        vim.api.nvim_set_hl(0, 'RenderMarkdownH1Bg', { ctermbg = vim.g.colors.main, ctermfg = vim.g.colors.black })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH2Bg', { ctermbg = vim.g.colors.main2, ctermfg = vim.g.colors.black })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH3Bg', { ctermbg = vim.g.colors.main3, ctermfg = vim.g.colors.black })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH4Bg', { ctermbg = vim.g.colors.secondary, ctermfg = vim.g.colors.black })
        vim.api.nvim_set_hl(0, 'RenderMarkdownH4Bg', { ctermbg = vim.g.colors.secondary2, ctermfg = vim.g.colors.black })
    end,
}
